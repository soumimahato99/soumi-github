...
path1 = r"C:\Users\hp5cd\OneDrive\Desktop\Forecasts_Models\frc_forcnn_usd.csv" #before inverse transformation
...
np.save(r"C:\Users\hp5cd\OneDrive\Desktop\Forecasts_Models\forecast_forcnn_usd_final.npy", inverse_transformed_y_hat)

# Save as CSV
save_forecasts = True
if save_forecasts:
    path = r"C:\Users\hp5cd\OneDrive\Desktop\Forecasts_Models\forecast_forcnn_usd_final.csv"
...
plt.plot(mlp_plt, label="forcnn_usd", color='red', linewidth=2)
...
plt.title('Actual Test Data vs Forecast by ForCNN')
...
print(y_test[1:5])
y_hat_test = np.load(r"C:\Users\hp5cd\OneDrive\Desktop\Forecasts_Models\forecast_forcnn_usd_final.npy")  # Test predicted data
